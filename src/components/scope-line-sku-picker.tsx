...
type Props = {
  ...
  inlineRow?: boolean;
  /**
   * Workbench: open a fixed popup listing supplier / model / URL / price.
   * Checklist keeps the native select (`"select"`).
   */
  skuPickerUi?: "select" | "popup";
    ...
    showIncludeAllSupplierOptions ? (
      ...
      >
        <input
          ...
          disabled={disabled}
          onChange={(e) => onIncludeAllSupplierOptionsChange?.(e.target.checked)}
        />
